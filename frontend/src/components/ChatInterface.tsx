  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content:
        "Hello! I am your Dragon capsule AI assistant. I can provide you with information about the spacecraft, mission status, technical specifications, and answer any questions you have about our journey. How can I help you today?",
      sender: "assistant",
      timestamp: new Date(),
    },
  ]);
